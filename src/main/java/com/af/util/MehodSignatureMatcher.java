...
public class MehodSignatureMatcher {
	...
	public static void main(String[] args) {
		try {
			//完全匹配
			Method method = MehodSignatureMatcher.getMatchingMethod(MehodSignatureMatcher.class, "test",
					new Object[]{A.class, I1.class});
			System.out.println(method.getName());
			//类传子类，接口传子接口
			method = MehodSignatureMatcher.getMatchingMethod(MehodSignatureMatcher.class, "test",
					new Object[]{C.class, I4.class});
			System.out.println(method.getName());
			//类传子类，接口传子类
			method = MehodSignatureMatcher.getMatchingMethod(MehodSignatureMatcher.class, "test",
					new Object[]{C.class, C.class});
			System.out.println(method.getName());
			//错误参数
			method = MehodSignatureMatcher.getMatchingMethod(MehodSignatureMatcher.class, "test",
					new Object[]{Object.class, C.class});
			System.out.println(method!=null ? method.getName() : "null");
			//错误参数
			method = MehodSignatureMatcher.getMatchingMethod(MehodSignatureMatcher.class, "test",
					new Object[]{C.class, Object.class});
			System.out.println(method!=null ? method.getName() : "null");
		} catch (Exception e) {
			e.printStackTrace();
		}
